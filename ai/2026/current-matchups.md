...
| Position | Player | Pro Team | Status | Projected Points |
|----------|--------|----------|--------|------------------|
| QB | Caleb Williams | CHI | Active | 16.3 |
...
| Position | Player | Pro Team | Status | Projected Points |
|----------|--------|----------|--------|------------------|
| QB | Josh Allen | BUF | Active | 19.3 |
| RB | Tony Pollard | TEN | Active | 11.5 |
| RB | Jeremiyah Love | ARI | Active | 14.7 |
| WR | Michael Pittman Jr. | PIT | Active | 12.3 |
...
| Bench | Mike Washington Jr. | LV | Active | 6.8 |
| Bench | Keenan Allen | IND | Active | 7.2 |
| Bench | Zavion Thomas | CHI | Active | 2.1 |
...
| Position | Player | Pro Team | Status | Projected Points |
|----------|--------|----------|--------|------------------|
| QB | Jalen Hurts | PHI | Active | 21.1 |
| RB | Saquon Barkley | PHI | Active | 17.7 |
| RB | Kenneth Walker III | KC | Active | 14.7 |
...
| Bench | Makai Lemon | PHI | Active | 8.5 |
| Bench | Jalen Coker | CAR | Active | 9.2 |
| Bench | Wan'Dale Robinson | TEN | Active | 10.4 |
| Bench | RJ Harvey | DEN | Active | 8.5 |
...
| Position | Player | Pro Team | Status | Projected Points |
|----------|--------|----------|--------|------------------|
| QB | Jaxson Dart | NYG | Active | 18.5 |
| RB | Bucky Irving | TB | Active | 12.4 |
| RB | D'Andre Swift | CHI | Active | 12.3 |
| WR | Puka Nacua | LAR | Active | 21.1 |
| WR | Carnell Tate | TEN | Active | 12.0 |
| TE | Colston Loveland | CHI | Active | 12.0 |
| FLEX | De'Von Achane | MIA | Active | 18.2 |
| D/ST | Steelers D/ST | PIT | Active | 7.5 |
| K | Eddy Pineiro | SF | Active | 8.6 |
| Bench | Stefon Diggs | WSH | Active | 9.7 |
| Bench | Patrick Mahomes | KC | Active | 15.5 |
| Bench | Jakobi Meyers | JAX | Active | 10.4 |
| Bench | Khalil Shakir | BUF | Active | 9.5 |
| Bench | Woody Marks | HOU | Active | 8.3 |
| Bench | Brenton Strange | JAX | Active | 8.1 |
...
| Position | Player | Pro Team | Status | Projected Points |
|----------|--------|----------|--------|------------------|
| QB | Bo Nix | DEN | Active | 16.2 |
| RB | Chase Brown | CIN | Active | 16.0 |
...
| Position | Player | Pro Team | Status | Projected Points |
|----------|--------|----------|--------|------------------|
| QB | Trevor Lawrence | JAX | Active | 17.0 |
| RB | Travis Etienne Jr. | NO | Active | 15.0 |
| RB | Jonathan Taylor | IND | Active | 17.8 |
| WR | Rashee Rice | KC | Active | 14.4 |
| WR | Ladd McConkey | LAC | Active | 13.8 |
| TE | Jake Ferguson | DAL | Active | 9.8 |
| FLEX | Rico Dowdle | PIT | Active | 12.5 |
...
| Position | Player | Pro Team | Status | Projected Points |
|----------|--------|----------|--------|------------------|
| QB | Justin Herbert | LAC | Active | 19.0 |
| RB | Kyren Williams | LAR | Active | 13.7 |
| RB | David Montgomery | HOU | Active | 12.7 |
| WR | CeeDee Lamb | DAL | Active | 17.2 |
| WR | Tetairoa McMillan | CAR | Active | 14.8 |
| TE | Brock Bowers | LV | Active | 15.6 |
| FLEX | Jaylen Waddle | DEN | Active | 12.2 |
| Bench | Courtland Sutton | DEN | Active | 11.7 |
| Bench | Dak Prescott | DAL | Active | 16.7 |
