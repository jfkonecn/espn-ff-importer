...
type KeeperEligibility struct {
	...
	IsEligible            bool
	KeeperYears           int
	AcquisitionType       string // "draft", "free_agency", or "free_agency_readd"
	OriginalDraftTeamName string
	CurrentPrice          int
	NextYearPrice         int
	IsKeeper              bool
}
...
// TransactionHistory contains ESPN's transaction feed for a season.
type TransactionHistory struct {
	Transactions []Transaction `json:"transactions"`
}

// Transaction represents a completed roster move recorded by ESPN.
...
// TransactionItem identifies the player and teams involved in a roster move.
